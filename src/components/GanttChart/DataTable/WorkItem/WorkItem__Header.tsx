...
const WorkItem__Header: React.FC<WorkItem__HeaderProps> = (props) => {
  ...
  const handleToggleStatus = () => {
    dispatch(setStatus({ workId: props.workId, status: props.status === WorkStatus.Hidden ? WorkStatus.Showing : WorkStatus.Hidden }))
  }
  ...
  return (
    <td className='work__header' style={ { paddingLeft } }>
      <div
        ...
        data-hidden={ props.status === WorkStatus.Hidden ? 'hidden' : 'showing' }
